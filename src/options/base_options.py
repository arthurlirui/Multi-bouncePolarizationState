...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--checkpoints_name', type=str, default='sepmodel', help='models are saved here')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='/home/lir0b/data/polar/realdata/dataset/part')
        ...
        self.parser.add_argument('--save_results_path', type=str, default='./exp', help='save resulst path')
